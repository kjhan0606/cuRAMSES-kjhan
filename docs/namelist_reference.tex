...
\begin{quote}
Dark energy sound speed squared $c_s^2$ (in units of $c^2$).  This
parameter is declared for future use in dark energy perturbation
theory (clustering dark energy) but is \textbf{not yet used} in the
current code.  Set to~0 for the standard smooth dark energy
assumption.
\end{quote}
