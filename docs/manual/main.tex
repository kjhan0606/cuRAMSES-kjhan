...
\midrule
\texttt{de\_perturb} & logical & \texttt{.false.} & Enable DE density perturbation in FFT Poisson solver \\
\midrule
...
\begin{itemize}[nosep]
  ...
  \item \texttt{de\_perturb} requires \texttt{cs2\_de} $> 0$ and a cosmological run.
