...
\begin{lstlisting}[style=fortran,numbers=none]
 SIDM level 14: scattered=      19 pairs=     52129
...
\end{itemize}
These should all be at machine-precision level ($\sim 10^{-15}$ relative to particle momentum, $\sim 10^{-13}$ relative to kinetic energy), confirming exact conservation up to floating-point roundoff.
