...
\item \textbf{GPU-accelerated solvers.} A dynamic dispatch model in
  which OMP threads acquire GPU stream slots at runtime, with fallback
  to CPU execution.  Batched grid buffering amortises kernel launch
  latency, and an on-device flux reduction reduces PCIe
