...
{cuRAMSES: Scalable Domain Decomposition, Solver Optimizations, and
Hybrid CPU/GPU Strategies for Cosmological AMR Simulations}
...
\item The average number of communication partners is constant at 6.0
  for \ksec\ across all rank counts, compared to 6.0--7.5 for Hilbert,
