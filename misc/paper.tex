...
\citep{Lee2021} and the NewCluster zoom-in simulation
\citep{Han2026} both employ RAMSES-yOMP, which adds OpenMP threading
within each MPI rank for improved intra-node scalability. However,
