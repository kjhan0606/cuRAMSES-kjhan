...
on 64--256~MPI ranks.  Key findings:

\begin{itemize}
\item The ghost list \emph{build time} is dominated by the Hilbert curve
  computation (${\sim}456$\,s, independent of rank count) versus the
  \ksec\ tree traversal which scales from 200\,s (64~ranks) to 288\,s
  (256~ranks).  At higher rank counts the \ksec\ advantage grows.
\item The \emph{exchange time} is sub-second for all methods.  P2P and
  \texttt{ALLTOALLV} are effectively tied (15--42\,$\mu$s), while the
  hierarchical \ksec\ exchange is ${\sim}10$--$15\times$ slower
  (200--370\,ms) due to its $O(\log P)$ serialised stages.
...
\item The average number of communication partners is 6.0 for \ksec\
  at all rank counts, compared to 6.0--6.8 for Hilbert, reflecting the
  compact cuboid sub-domains produced by recursive bisection.
\end{itemize}

\begin{table}
\centering
\caption{Ghost zone exchange benchmark for $N=1024$ ($10^9$~cells,
  $n_{\rm var}=5$) on the \textit{Grammar} cluster.
...
\hline
 64 & Hilbert   & 453.5 & 0.023 & 6.0 & P2P       & $0.042\pm0.002$ \\
    &           &       &       &     & A2AV      & $0.034\pm0.000$ \\
    &           &       &       &     & K-Sec     & $0.368\pm0.005$ \\
    & K-Section & 200.4 & 0.023 & 6.0 & P2P       & $0.030\pm0.000$ \\
    &           &       &       &     & A2AV      & $0.027\pm0.001$ \\
    &           &       &       &     & K-Sec     & $0.365\pm0.004$ \\
\hline
128 & Hilbert   & 455.6 & 0.031 & 7.4 & P2P       & $0.025\pm0.003$ \\
    &           &       &       &     & A2AV      & $0.018\pm0.000$ \\
    &           &       &       &     & K-Sec     & $0.248\pm0.005$ \\
    & K-Section & 237.6 & 0.031 & 6.0 & P2P       & $0.023\pm0.001$ \\
    &           &       &       &     & A2AV      & $0.018\pm0.000$ \\
    &           &       &       &     & K-Sec     & $0.235\pm0.001$ \\
\hline
256 & Hilbert   & 456.0 & 0.039 & 6.8 & P2P       & $0.017\pm0.002$ \\
    &           &       &       &     & A2AV      & $0.016\pm0.002$ \\
    &           &       &       &     & K-Sec     & $0.218\pm0.002$ \\
    & K-Section & 288.2 & 0.039 & 6.0 & P2P       & $0.019\pm0.003$ \\
    &           &       &       &     & A2AV      & $0.015\pm0.000$ \\
    &           &       &       &     & K-Sec     & $0.202\pm0.000$ \\
\hline
\end{tabular}
