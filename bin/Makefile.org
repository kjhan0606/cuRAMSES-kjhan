...
# --- MPI, ifort syntax ------------------------------
F90 = mpiifort -qopenmp #-xMIC-AVX512
FFLAGS = -cpp -O3 $(DEFINES) -DNOSYSTEM -DLONGINT -DQUADHILBERT -DOUTPUT_PARTICLE_POTENTIAL
#FFLAGS = -cpp -O3 $(DEFINES) -DNOSYSTEM -DLONGINT -DQUADHILBERT 
...
AMROBJ = read_params.jaehyun.o init_amr.o init_time.o init_refine.o adaptive_loop.jaehyun.o amr_step.o update_time.o \
         ...
         hilbert.o load_balance.kjhan.o title.o sort.o cooling_fine.kjhan.o units.o light_cone.part.o light_cone.hydro.o light_cone.sink2.o movie_mod.yonghwi_org.o kjhan.o
...
PMOBJ = init_part.o output_part.o rho_fine.kjhan.o synchro_fine.kjhan.o move_fine.o newdt_fine.kjhan.o particle_tree.kjhan.o \
        add_list.o remove_list.o star_formation.kjhan.o sink_particle.kjhan.o feedback.kjhan.o \
