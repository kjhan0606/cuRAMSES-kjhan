...
!#########################################################
!#########################################################
subroutine sub1_force_fine(ilevel,igrid, ngrid)
  use amr_commons
  use pm_commons
  use poisson_commons
  implicit none
  ...
  common /force_fine_common/ skip_loc, scale, dx_loc
  do i=1,ngrid
     ind_grid(i)=active(ilevel)%igrid(igrid+i-1)
  end do
...
end subroutine sub1_force_fine
!#########################################################
!#########################################################
!#########################################################
!#########################################################
...
!$omp parallel private(igrid,ngrid)
     do igrid=1,ncache,nvector
        ngrid=MIN(nvector,ncache-igrid+1)
        call sub1_force_fine(ilevel, igrid,ngrid)
     end do
     ! End loop over grids
