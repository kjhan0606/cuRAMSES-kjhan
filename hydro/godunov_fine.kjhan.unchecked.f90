...
#else
  integer,target, allocatable, dimension(:,:) ::Pind_grid
  integer,pointer, dimension(:)::ind_grid
  common /omp_god_fine/ ind_grid
!$omp threadprivate(/omp_god_fine/)
  integer:: nthreads,mythread,k
  common /omp_threads_info/ nthreads, mythread
!$omp threadprivate(/omp_threads_info/)
#endif
...
!!$omp parallel do private(igrid,i, ngrid) schedule(dynamic)
...
111 format('   Entering godunov_fine for level ',i2)
#endif
! print *, 'normal exit', myid
! call mpi_finalize(ivar)
! stop
