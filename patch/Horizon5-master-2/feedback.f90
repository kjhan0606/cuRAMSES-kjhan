...
subroutine thermal_feedback(ilevel)
  ...
  real,dimension(:),allocatable::val3,astarproper
  ...
  real(dp),dimension(1:nvector),save::mej,zej,nbsn1,nbsn2
...
subroutine feedbk(ind_grid,ind_part,ind_grid_part,mej,nbsn1,nbsn2,zej,ceej,ESN1,ESN2,ng,np,ilevel)
  ...
  real(dp),dimension(1:nvector),save::mloss,ekinetic
...
!  integer,dimension(:),allocatable::ind_part,ind_grid
  ...
  integer::allocatestat1,allocatestat2,allocatestat3,allocatestat4,allocatestat5,allocatestat6,allocatestat7,allocatestat8,allocatestat9
