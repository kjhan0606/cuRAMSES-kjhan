...
!  character(LEN=80)::filename2,fileloc2
!  integer ::ilun2
...
!     filename2=TRIM(filedir)//'binstars_'//TRIM(nchar)//'.out'
     ilun=myid+10
!     ilun2=myid+1000
     call title(myid,nchar)
     fileloc=TRIM(filename)//TRIM(nchar)
!     fileloc2=TRIM(filename2)//TRIM(nchar)
     ! Wait for the token
#ifndef WITHOUTMPI
...
!  if(sf_birth_properties) close(ilun2)
