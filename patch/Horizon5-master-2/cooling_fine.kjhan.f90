...
#ifdef _OPENMP
#ifdef RT
#error _OPENMP and RT are mutual exclusive
#endif
#endif
#ifndef _OPENMP
  ...
  ! Compute polytropic floor coefficients for hydro solver (ctoprim/cmpdt)
...
subroutine init_eeos_poly_coeff
  ! Compute polytropic floor coefficients for hydro solver (ctoprim/cmpdt)
  ! Called once at startup, before the main time loop
  use amr_commons
  use hydro_commons
  use cooling_module
  implicit none
